package com.pir_online.test_assignment_pir.config;

import com.pir_online.test_assignment_pir.security.JwtTokenFilter;
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                ...
                .info(new Info()
                        ...
                        .description("Project management on Spring Boot")
                        .version("1.0"));
    }
